...
class FlowLayout(QLayout):
    ...
    def _do_layout(self, rect, test_only):
        ...
        for item in self._item_list:
            ...
            # Use a fixed spacing value instead of querying style
            space_x = spacing if spacing >= 0 else 5
            space_y = spacing if spacing >= 0 else 5
            
            # Try to get style spacing, but fall back to fixed values if it fails
            try:
                style = widget.style()
                ...
                # Style object deleted or unavailable, use fallback spacing
                pass
